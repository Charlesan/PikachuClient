...
public class UserDao {
	...
	{
		String httpUrl = CommonSetting.MYURL+"register.php?uloginid="+strLoginId+"&upwd="+strLoginPwd+"&uname="+strName;
	...
	{
		String httpUrl = CommonSetting.MYURL+"login.php?uloginid="+strLoginId+"&upwd="+strLoginPwd;
		HttpGet httpRequest = new HttpGet(httpUrl);
		try
		{
			HttpClient httpcliet = new DefaultHttpClient();
	...
	{
		String httpUrl = CommonSetting.MYURL+"getusermsg.php?uloginid="+strLoginId;
		HttpGet httpRequest = new HttpGet(httpUrl);
		try
		{
			HttpClient httpcliet = new DefaultHttpClient();
	...
	{
		String httpUrl = CommonSetting.MYURL+"getuserrank.php?uloginid="+strLoginId;
		HttpGet httpRequest = new HttpGet(httpUrl);
		try
		{
			HttpClient httpcliet = new DefaultHttpClient();
	...
	{
		String httpUrl = CommonSetting.MYURL+"getuserhandbook.php?uloginid="+strLoginId;
		HttpGet httpRequest = new HttpGet(httpUrl);
		try
		{
			HttpClient httpcliet = new DefaultHttpClient();
	...
	{
		String httpUrl = CommonSetting.MYURL+"rename.php?uloginid="+strLoginId+"&uname="+strName;
		HttpGet httpRequest = new HttpGet(httpUrl);
		try
		{
			HttpClient httpcliet = new DefaultHttpClient();
	...
	public int repassword(String strLoginId, String strLoginPwd, String strNewPwd)
	{
		String httpUrl = CommonSetting.MYURL+"repassword.php?uloginid="+strLoginId+"&uloginpwd="+strLoginPwd+"&newuloginpwd="+strNewPwd;
		HttpGet httpRequest = new HttpGet(httpUrl);
		try
		{
			HttpClient httpcliet = new DefaultHttpClient();
	...
	{
		String httpUrl = CommonSetting.MYURL+"catchmonster.php?uid="+nUid+"&mid="+nMid;
		HttpGet httpRequest = new HttpGet(httpUrl);
		try
		{
			HttpClient httpcliet = new DefaultHttpClient();
